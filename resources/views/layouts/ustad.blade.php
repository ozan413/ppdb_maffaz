...
<head>
    ...
    <title>@yield('title', 'Dashboard Ustad') - PPDB Maskanul Huffadz</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-info { background: rgba(184, 134, 11, 0.1); color: var(--primary-gold); }
    ...
    <div class="dashboard-layout">
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('ustad.dashboard') }}" class="{{ request()->routeIs('ustad.dashboard') ? 'active' : '' }}"><i class="fas fa-home"></i> Dashboard</a></li>
                
                <li class="sidebar-menu-title">Wawancara</li>
                <li><a href="{{ route('ustad.interview.index') }}" class="{{ request()->routeIs('ustad.interview.index') ? 'active' : '' }}"><i class="fas fa-calendar-check"></i> Jadwal Wawancara</a></li>
                <li><a href="{{ route('ustad.interview.completed') }}" class="{{ request()->routeIs('ustad.interview.completed') ? 'active' : '' }}"><i class="fas fa-check-double"></i> Wawancara Selesai</a></li>
